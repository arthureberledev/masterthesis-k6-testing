...
// let ENV_TO_RUN = "prod"; // default
// if (__ENV.ENV_TO_RUN) {
//   ENV_TO_RUN = __ENV.ENV_TO_RUN;
// }
...
switch (Architecture) {
  ...
  case ArchitectureType.monolithic:
    BASE_URL =
      "https://ec2-18-153-71-101.eu-central-1.compute.amazonaws.com:3000";
    break;
...
const Execution = TEST_TO_RUN; // ExecutionType.smoke;
...
export const options = {
  ...
  thresholds: {
    ...
    "http_req_duration{name:PublicCrocs}": ["avg<400"], // CHECK
...
export function BackendReadTest() {
  ...
  // let res = http.get(`${BASE_URL}/public/crocodiles/1/`, {
  ...
  if (isSuccessfulRequest) {
    ...
    check(name, {
      "The name is correct": name == `Test Product ${productId}`,
    });
  }
}
...
export function setup() {
  ...
  // Log the environment
  DebugOrLog(`This test will run on the ${ENV_TO_RUN} environment.`);
